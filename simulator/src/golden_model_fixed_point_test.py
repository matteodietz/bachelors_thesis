...
from golden_model_fixed_point import (
    quantize,
    dequantize,
    streaming_dft_processor_fixed_point,
...
if __name__ == '__main__':
    ...
    dft_bins = streaming_dft_processor_fixed_point(time_window_data, fs_baseline, S_bins, window='hann')
